     ...
     <div className="grid lg:grid-cols-2 gap-12">
       ...
       <div className="space-y-8">
         <div className="flex gap-4 items-start animate__animated animate__fadeInLeft">
           ...
           <div>
             <h3 className="text-xl font-semibold text-white mb-2">10x Faster Analysis</h3>
             <p className="text-neutral-400">Process and analyze large datasets in seconds with our optimized analytics engine.</p>
           </div>
         </div>
         ...
         <div className="flex gap-4 items-start animate__animated animate__fadeInLeft animate__delay-1s">
           ...
           <div>
             ...
             <p className="text-neutral-400">Bank-level encryption and security measures to protect your sensitive data.</p>
           </div>
         </div>
         ...
         <div className="flex gap-4 items-start animate__animated animate__fadeInLeft animate__delay-2s">
           ...
           <div>
             ...
             <p className="text-neutral-400">Get instant insights with real-time data processing and live dashboards.</p>
           </div>
         </div>
       </div>
           ...
           <div className="relative">
             ...
             <div className="bg-neutral-800 rounded-xl p-6 shadow-lg">
               <div className="flex items-center justify-between mb-4">
                 <h4 className="text-white font-semibold">Growth Analysis</h4>
