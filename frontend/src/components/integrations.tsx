            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <div className="bg-neutral-800 rounded-xl p-6 hover:bg-neutral-700 transition-all duration-300 animate__animated animate__fadeInUp">
                    <div className="flex items-center mb-4">
                        ...
                        <div className="ml-4">
                            <h3 className="text-white font-semibold text-lg">Slack Integration</h3>
                            <p className="text-gray-400 text-sm">Real-time notifications</p>
                        </div>
                    </div>
                    <p className="text-gray-300 mb-4">Get analytics updates directly in your Slack channels</p>
                ...
                <div className="bg-neutral-800 rounded-xl p-6 hover:bg-neutral-700 transition-all duration-300 animate__animated animate__fadeInUp animate__delay-1s">
                    <div className="flex items-center mb-4">
                        ...
                        <div className="ml-4">
                            <h3 className="text-white font-semibold text-lg">Zapier Integration</h3>
                            <p className="text-gray-400 text-sm">Automated workflows</p>
                        </div>
                    </div>
                    <p className="text-gray-300 mb-4">Automate tasks between 3000+ apps</p>
                    <button className="text-violet-400 hover:text-violet-300 flex items-center">
                        Connect
                        <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path>
                ...
                <div className="bg-neutral-800 rounded-xl p-6 hover:bg-neutral-700 transition-all duration-300 animate__animated animate__fadeInUp animate__delay-2s">
                    <div className="flex items-center mb-4">
                        ...
                        <div className="ml-4">
                            <h3 className="text-white font-semibold text-lg">Microsoft Integration</h3>
                            <p className="text-gray-400 text-sm">Office 365 connection</p>
                        </div>
                    </div>
                    <p className="text-gray-300 mb-4">Sync with Microsoft tools seamlessly</p>
                    <button className="text-violet-400 hover:text-violet-300 flex items-center">
                        Connect
                        <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path>
                ...
                <div className="bg-neutral-800 rounded-xl p-6 hover:bg-neutral-700 transition-all duration-300 animate__animated animate__fadeInUp">
                    <div className="flex items-center mb-4">
                        ...
                        <div className="ml-4">
                            <h3 className="text-white font-semibold text-lg">Google Integration</h3>
                            <p className="text-gray-400 text-sm">Google Workspace sync</p>
                        </div>
                    </div>
                    <p className="text-gray-300 mb-4">Connect with Google's powerful tools</p>
                    <button className="text-violet-400 hover:text-violet-300 flex items-center">
                        Connect
                        <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path>
                ...
                <div className="bg-neutral-800 rounded-xl p-6 hover:bg-neutral-700 transition-all duration-300 animate__animated animate__fadeInUp animate__delay-1s">
                    <div className="flex items-center mb-4">
                        ...
                        <div className="ml-4">
                            <h3 className="text-white font-semibold text-lg">Notion Integration</h3>
                            <p className="text-gray-400 text-sm">Documentation sync</p>
                        </div>
                    </div>
                    <p className="text-gray-300 mb-4">Keep your docs and analytics in sync</p>
                    <button className="text-violet-400 hover:text-violet-300 flex items-center">
                        Connect
                        <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path>
                ...
                <div className="bg-neutral-800 rounded-xl p-6 hover:bg-neutral-700 transition-all duration-300 animate__animated animate__fadeInUp animate__delay-2s">
                    <div className="flex items-center mb-4">
                        ...
                        <div className="ml-4">
                            <h3 className="text-white font-semibold text-lg">Trello Integration</h3>
                            <p className="text-gray-400 text-sm">Project tracking</p>
                        </div>
                    </div>
                    <p className="text-gray-300 mb-4">Link analytics with your project boards</p>
                    <button className="text-violet-400 hover:text-violet-300 flex items-center">
                        Connect
                        <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path>
