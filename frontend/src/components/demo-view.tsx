...
export default function DemoView() {
  return (
    <section id="demo" className="bg-neutral-900 py-20 relative overflow-hidden">
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        <div className="animate__animated animate__fadeInLeft">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            See Our Platform <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-600">in Action</span>
          </h2>
          <p className="text-neutral-400 text-lg mb-8">
            Watch how our analytics platform can transform your data into actionable insights in minutes.
          </p>
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-center">
              ...
              <span className="text-neutral-300">Real-time data visualization</span>
            </div>
            <div className="flex items-center">
              <svg className="w-6 h-6 text-blue-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
              </svg>
              <span className="text-neutral-300">Customizable dashboards</span>
            </div>
            <div className="flex items-center">
              <svg className="w-6 h-6 text-blue-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
              </svg>
              <span className="text-neutral-300">Advanced reporting features</span>
            </div>
          </div>
