...
export const userVerifiedHostnames = table(
  "user_verified_hostnames",
  {
    userId: integer()
      .notNull()
...
export const userUnverifiedHostnames = table(
  "user_unverified_hostnames",
  {
    userId: integer()
      .notNull()
      .references(() => usersTable.id),
    uvHostnameId: integer()
      .notNull()
